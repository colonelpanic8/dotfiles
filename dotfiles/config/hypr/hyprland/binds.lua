...
function M.setup(ctx)
  ...
  local function setup_display_wallpaper_and_capture_bindings()
    ...
    bind("SHIFT + Print", exec("screen-record toggle region"), desc("Record a screen region (toggle)"))
    bind("CTRL + Print", exec("screen-record toggle monitor"), desc("Record the focused monitor (toggle)"))
    bind(hyper .. " + SHIFT + H", exec("screen-record toggle region"), desc("Record a screen region (toggle)"))
    bind(hyper .. " + SHIFT + J", exec("screen-record toggle window"), desc("Record the focused window (toggle)"))
  ...
  local function setup_scratchpad_bindings()
    ...
    bind(mod_alt .. " + L", function()
      toggle_scratchpad("localsend")
    end, desc("Toggle LocalSend scratchpad"))
    ...
    bind(mod_alt .. " + T", function()
      toggle_scratchpad("t3code")
    end, desc("Toggle T3 Code scratchpad"))
    bind(mod_alt .. " + P", function()
      toggle_scratchpad("paseo")
    end, desc("Toggle Paseo scratchpad"))
